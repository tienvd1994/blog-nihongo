(function () {
    ...
    HeaderController.$inject = ["$rootScope", "$scope", "$timeout", "$state", "Auth", "NotificationManager", "SubcategoryManager", "LectureManager", "Restangular", "AUTH_EVENTS", "HOME_EVENTS", "LANG_KEY", "myCourses", "MYCOURSE_EVENTS", "Facebook", "CART_STORAGE_KEY"];
